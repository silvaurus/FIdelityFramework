        ...
        with tf.variable_scope("encoder", reuse=tf.AUTO_REUSE):
            ...
            for i in range(self.hp.num_blocks):
                with tf.variable_scope("num_blocks_{}".format(i), reuse=tf.AUTO_REUSE):
                    ...
                    # feed forward
                    enc = ff(enc, num_units=[self.hp.d_ff, self.hp.d_model], inj_type=self.inj_type, quant_min_max=self.quant_min_max, inj_layer=self.inj_layer)
        memory = enc
            ...
            for i in range(self.hp.num_blocks):
                with tf.variable_scope("num_blocks_{}".format(i), reuse=tf.AUTO_REUSE):
                    ...
                    dec = multihead_attention(queries=dec,
                                              ...
                                              inj_layer=self.inj_layer)
                    ### Feed Forward
                    dec = ff(dec, num_units=[self.hp.d_ff, self.hp.d_model], inj_type=self.inj_type, quant_min_max=self.quant_min_max, inj_layer=self.inj_layer)
